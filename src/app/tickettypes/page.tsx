      ...
      <div className='relative min-h-screen h-full flex flex-col overflow-hidden sm:-mt-16'>
        ...
        <div className='flex flex-col flex-grow sm:text-xs lg:text-lg xl:text-xl'>
          <div className='flex relative justify-center mt-[8rem] xl:-mt-4 lg:mb-16 sm:mt-8 md:mb-12'>
            <img src="/ticket/tickettypes/ticket-types-text.svg" alt="Ticket Text" className='w-3/5 sm:w-[70%] md:w-2/5'/>
          </div>
          ...
          <div className='flex relative justify-center mr-12 md:mb-8 lg:mb-0 sm:mr-[20rem] sm:-mt-10 md:-mt-[9rem] lg:mr-[22rem] lg:-mt-[7rem]  xl:mr-[35rem] xl:mt-[-9rem]'>
            <a href='/tickettypes/purchaseticket' className='flex relative items-center w-4/5 sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] hover:scale-110 transition ease-in-out z-20'>
              <img src="/ticket/tickettypes/ticket-1.svg" alt="Ticket Candy 1" className='w-full' />
          ...
          <div className='flex relative justify-center'>
            <a href='/tickettypes/purchaseticket' className='z-20 flex relative items-center hover:scale-110 transition ease-in-out ml-8 sm:ml-0 -mt-12 w-4/5 sm:w-[45%] md:-mt-[4rem] md:w-[40%] lg:-mt-[3rem] lg:w-[35%] xl:w-[30%] 2xl:-mt-[4rem]'>
              <img src="/ticket/tickettypes/ticket-2.svg" alt="Ticket Candy 2" className='w-full' />
