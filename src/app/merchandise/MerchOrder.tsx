...
const MerchandisePage: React.FC = () => {
  ...
  const products = [
    { image:"/icon.ico", harga: 55000, nama: "Product Name", description: 'Product Description' },
    { image:"/icon.ico", harga: 55000, nama: "Product Name", description: 'Product Description' },
    { image:"/icon.ico", harga: 55000, nama: "Product Name", description: 'Product Description' },
    { image:"/icon.ico", harga: 55000, nama: "Product Name", description: 'Product Description' },
    { image:"/icon.ico", harga: 55000, nama: "Product Name", description: 'Product Description' },
  ...
  const handleCheckout = () => {
    ...
    console.log(merchValues.cart)
    
    if (merchValues.cart.products.length > 0 || merchValues.cart.bundles.length > 0) {
