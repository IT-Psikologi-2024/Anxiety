...
const ConfirmationModal = () => {
  ...
  return (
    <div className="flex flex-col relative items-center justify-center w-full h-fit mt-[5vh] z-10 space-y-4 mb-8">
      ...
      <div className={`flex flex-col lg:flex-row px-8 items-center justify-center`}>
        {merchValues.isBaju && 
          <div className='flex sm:max-w-[80%] md:max-w-[70%] lg:max-w-[50%] lg:min-w-[40%] p-4 items-center justify-center'>
            <div className='h-1/2'>
              <img src="/sizechart.svg" alt="Size Chart" />
            </div>
          </div>
          }
        <div className="flex relative flex-col max-h-[300px] min-w-fit w-4/5 sm:w-3/5 lg:max-w-[50%] h-fit px-5 space-y-6 mb-12">
