    ...
    <div className='flex flex-col'>
      ...
      <div className='min-h-[2321px] sm:min-h-[3855px] h-full flex flex-col overflow-hidden relative'>
        ...
        <div className='flex flex-col flex-grow'>
          ...
          <div className='flex absolute top-[75vh] right-[-10rem] sm:right-0 sm:top-[111vh]'>
          ...
          <div className='flex flex-col absolute items-end p-6 bottom-0 w-full bg-[#FBB3D7] h-[5%] sm:h-[2.5%]'>
            ...
            <button className='bg-[#618758] text-white rounded-[34.15px] w-1/4 sm:w-1/5 md:w-[15%] xl:w-[12%]'>
              Check Out
            </button>
          </div>
        </div>
