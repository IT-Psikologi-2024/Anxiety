...
const PaymentPage = () => {
  ...
  return (
    <div className="flex flex-col">
        <Navbar />
        <div className="min-h-[1413px] max-h-[1413px] sm:min-h-[1800px] sm:max-h-[1800px] h-full flex flex-col overflow-hidden relative">
          <MerchBackground />
          <div className="flex flex-col flex-grow">
            ...
            <div className='flex absolute justify-end right-0 bottom-[40vh]'>
              <img src="/merch/loli-kanan.svg" alt="Loli Kanan" className='w-3/4'/>
            </div>
            ...
            <div className='flex absolute bottom-[40vh]'>
              <img src="/merch/payment/loli-kiri.svg" alt="Loli Kiri" className='w-3/4'/>
            </div>
            
            <div className='h-[1800px] w-full relative flex items-center justify-center'>
              <div className='w-4/5 h-4/5 bg-[#C8E3F6CC] backdrop-opacity-10 rounded-[25px] shadow-inner-custom flex flex-col text-product-color p-16 font-black space-y-6'>
                <p className='text-6xl text-center italic'>Pembayaran</p>
                <div className='flex flex-col w-full h-1/4 space-y-4'>
                  <div className='bg-white h-[30%] w-full rounded-[19px] shadow-inner-custom p-4 '>
                ...
                <p className='text-6xl text-center italic'>QRIS</p>
                <div className='relative w-full flex justify-center'>
                  <div className='w-full bg-white flex justify-center items-center rounded-[19px] shadow-inner-custom p-8'>
                    <img src="/merch/payment/qris.svg" alt="" className='xl:w-2/5 2xl:w-1/3'/>
                  </div>
                </div>

                <p className='text-6xl text-center italic'>Bukti Pembayaran</p>
                <div className='flex justify-center w-4/5 space-y-4 h-[7.5%] text-2xl self-center'>
                  <label
                    htmlFor="file-input"
                    className='bg-white w-full h-full rounded-[19px] shadow-inner-custom flex justify-center items-center cursor-pointer'
                  >
                    <span className="text-gray-500">
                      {selectedFileBayar ? selectedFileBayar.name : "Input File Here"}
                    </span>
                    <input
                      type="file"
                ...
                <div className='flex relative w-full justify-center items-center'>
                    <button className='bg-[#FBB3D7] text-black sm:text-xl drop-shadow-md rounded-[37px] z-10 hover:scale-110 transition ease-in-out px-4 py-2'>
                        Kirim Bukti Bayar
                    </button>
                </div>
              </div>
