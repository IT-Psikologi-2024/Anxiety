      ...
      <div className="min-h-[2321px] max-h-[2321px] sm:min-h-[3962px] sm:max-h-[3962px] h-full flex flex-col overflow-hidden relative">
        ...
        <div className="flex flex-col flex-grow">
            ...
            <div className="flex flex-col relative items-center justify-center w-full mt-[5vh] sm:mt-[15vh] h-fit z-10">
              ...
              <div className="flex relative flex-col w-4/5 bg-[#C8E3F6CC] backdrop-opacity-10 h-[900px] sm:h-[1536px] rounded-[25px] mt-10 p-8 sm:p-16 space-y-4 sm:space-y-12 shadow-inner-custom">
                <MerchInput
                  label="Nama Lengkap"
                  id="namaLengkap"
                ...
                <div className="flex flex-col w-full space-y-2 sm:space-y-8 ml-3">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-black text-product-color mb-2 sm:mt-0 mt-4">Pengambilan Barang</p>
                  <RadioInput
            ...
            <div className='flex flex-col relative items-center justify-center w-full h-fit mt-[10vh] z-10'>
                ...
                <div className="flex relative flex-col w-4/5 bg-[#C8E3F6CC] backdrop-opacity-10 h-[600px] rounded-[25px] mt-5 sm:mt-10 px-5 py-2 sm:p-16 space-y-6 sm:space-y-12 shadow-inner-custom">
            ...
            <div className='flex relative justify-center w-full h-fit mt-12 sm:mt-[10vh]'>
                <div className='flex relative flex-col items-center w-4/5 bg-[#c8e3f696] h-[350px] sm:h-[489px] rounded-[25px] sm:mt-10 p-8 sm:p-16 space-y-4 sm:space-y-8 lg:space-y-12 shadow-inner-custom'>
                    ...
                    <div className='flex relative w-full h-1/5 justify-center items-center'>
                        <button className='bg-[#FBB3D7] text-black sm:text-2xl drop-shadow-md rounded-[37px] w-3/5 sm:w-1/2 md:w-2/5 lg:w-[29%] 2xl:w-1/5 h-3/5 sm:h-4/5 z-10'>
                            Bayar Sekarang
                        </button>
                    </div>
                </div>
