...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div className='flex flex-col items-center relative sm:h-[450px] md:h-[500px] lg:h-[490px] xl:h-[550px] 2xl:h-[610px] xl:w-[350px] 2xl:w-[410px] bg-[#C8E3F6] rounded-[80px] p-6 shadow-custom-outer space-y-6'>
      ...
      <div className='text-center text-product-color font-extrabold flex flex-col justify-center items-center'>
        <p className='sm:text-2xl lg:text-3xl xl:text-4xl'>{nama}</p>
        <p>{description}</p>
